    ...
    <main>
        <section class="hero-section d-flex align-items-center">
            <div class="container text-center">
                <div class="fade-in">
                    <h1 class="display-2 mb-4 fw-bold" style="font-family: 'Playfair Display', serif;">Don Macchiatos</h1>
                    <p class="lead mb-5 mx-auto" style="max-width: 800px;">
                        We source only the highest quality tea leaves, fresh milk, and natural ingredients to bring you a rich, authentic taste with every sip. From classic flavors to creative blends, <span class="text-orange">" DON MACCHIATOS "</span> guarantees a taste that delights.   
                    </p>
                    <a href="{{ '/HomePage' }}" class="btn btn-orange btn-lg rounded-pill px-5 py-3 fw-semibold text-uppercase">
                        Welcome Admin
                    </a>
                </div>
            </div>
